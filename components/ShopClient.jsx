      ...
      <div className="flex flex-col gap-10 lg:flex-row">
        ...
        <section className="flex-1 space-y-8">
          ...
          {filteredProducts.length > 0 ? (
            ...
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 sm:gap-5 md:grid-cols-3 md:gap-4 lg:grid-cols-3 lg:gap-4 xl:grid-cols-4 xl:gap-4 2xl:grid-cols-5 2xl:gap-4">
